...
const file_transaction_transaction_proto_rawDesc = "" +
	...
	"\x10transaction_type\x18\a \x01(\tR\x0ftransactionType\x12#\n" +
	"\rcurrency_code\x18\b \x01(\tR\fcurrencyCode\x12\x16\n" +
	"\x06active\x18\t \x01(\bR\x06active2\xb8\f\n" +
	...
	"\tDeleteFee\x12\x1d.transaction.DeleteFeeRequest\x1a\x1e.transaction.DeleteFeeResponseB9Z7github.com/exbanka/contract/transactionpb;transactionpbb\x06proto3"
...
var file_transaction_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_transaction_transaction_proto_goTypes = []any{
	...
	(*ListFeesRequest)(nil),                  // 27: transaction.ListFeesRequest
	(*ListFeesResponse)(nil),                 // 28: transaction.ListFeesResponse
	(*CreateFeeRequest)(nil),                 // 29: transaction.CreateFeeRequest
	(*UpdateFeeRequest)(nil),                 // 30: transaction.UpdateFeeRequest
	(*DeleteFeeRequest)(nil),                 // 31: transaction.DeleteFeeRequest
	(*DeleteFeeResponse)(nil),                // 32: transaction.DeleteFeeResponse
	(*TransferFeeResponse)(nil),              // 33: transaction.TransferFeeResponse
}
var file_transaction_transaction_proto_depIdxs = []int32{
	...
	33, // 4: transaction.ListFeesResponse.fees:type_name -> transaction.TransferFeeResponse
	0,  // 5: transaction.TransactionService.CreatePayment:input_type -> transaction.CreatePaymentRequest
	25, // 6: transaction.TransactionService.ExecutePayment:input_type -> transaction.ExecutePaymentRequest
	...
	5,  // 9: transaction.TransactionService.CreateTransfer:input_type -> transaction.CreateTransferRequest
	26, // 10: transaction.TransactionService.ExecuteTransfer:input_type -> transaction.ExecuteTransferRequest
	6,  // 11: transaction.TransactionService.GetTransfer:input_type -> transaction.GetTransferRequest
	7,  // 12: transaction.TransactionService.ListTransfersByClient:input_type -> transaction.ListTransfersByClientRequest
	10, // 13: transaction.TransactionService.CreatePaymentRecipient:input_type -> transaction.CreatePaymentRecipientRequest
	11, // 14: transaction.TransactionService.ListPaymentRecipients:input_type -> transaction.ListPaymentRecipientsRequest
	13, // 15: transaction.TransactionService.UpdatePaymentRecipient:input_type -> transaction.UpdatePaymentRecipientRequest
	14, // 16: transaction.TransactionService.DeletePaymentRecipient:input_type -> transaction.DeletePaymentRecipientRequest
	17, // 17: transaction.TransactionService.GetExchangeRate:input_type -> transaction.GetExchangeRateRequest
	18, // 18: transaction.TransactionService.ListExchangeRates:input_type -> transaction.ListExchangeRatesRequest
	21, // 19: transaction.TransactionService.CreateVerificationCode:input_type -> transaction.CreateVerificationCodeRequest
	23, // 20: transaction.TransactionService.ValidateVerificationCode:input_type -> transaction.ValidateVerificationCodeRequest
	27, // 21: transaction.FeeService.ListFees:input_type -> transaction.ListFeesRequest
	29, // 22: transaction.FeeService.CreateFee:input_type -> transaction.CreateFeeRequest
	30, // 23: transaction.FeeService.UpdateFee:input_type -> transaction.UpdateFeeRequest
	31, // 24: transaction.FeeService.DeleteFee:input_type -> transaction.DeleteFeeRequest
	4,  // 25: transaction.TransactionService.CreatePayment:output_type -> transaction.PaymentResponse
	4,  // 26: transaction.TransactionService.ExecutePayment:output_type -> transaction.PaymentResponse
	4,  // 27: transaction.TransactionService.GetPayment:output_type -> transaction.PaymentResponse
	3,  // 28: transaction.TransactionService.ListPaymentsByAccount:output_type -> transaction.ListPaymentsResponse
	9,  // 29: transaction.TransactionService.CreateTransfer:output_type -> transaction.TransferResponse
	9,  // 30: transaction.TransactionService.ExecuteTransfer:output_type -> transaction.TransferResponse
	9,  // 31: transaction.TransactionService.GetTransfer:output_type -> transaction.TransferResponse
	8,  // 32: transaction.TransactionService.ListTransfersByClient:output_type -> transaction.ListTransfersResponse
	16, // 33: transaction.TransactionService.CreatePaymentRecipient:output_type -> transaction.PaymentRecipientResponse
	12, // 34: transaction.TransactionService.ListPaymentRecipients:output_type -> transaction.ListPaymentRecipientsResponse
	16, // 35: transaction.TransactionService.UpdatePaymentRecipient:output_type -> transaction.PaymentRecipientResponse
	15, // 36: transaction.TransactionService.DeletePaymentRecipient:output_type -> transaction.DeletePaymentRecipientResponse
	19, // 37: transaction.TransactionService.GetExchangeRate:output_type -> transaction.ExchangeRateResponse
	20, // 38: transaction.TransactionService.ListExchangeRates:output_type -> transaction.ListExchangeRatesResponse
	22, // 39: transaction.TransactionService.CreateVerificationCode:output_type -> transaction.CreateVerificationCodeResponse
	24, // 40: transaction.TransactionService.ValidateVerificationCode:output_type -> transaction.ValidateVerificationCodeResponse
	28, // 41: transaction.FeeService.ListFees:output_type -> transaction.ListFeesResponse
	33, // 42: transaction.FeeService.CreateFee:output_type -> transaction.TransferFeeResponse
	33, // 43: transaction.FeeService.UpdateFee:output_type -> transaction.TransferFeeResponse
	32, // 44: transaction.FeeService.DeleteFee:output_type -> transaction.DeleteFeeResponse
