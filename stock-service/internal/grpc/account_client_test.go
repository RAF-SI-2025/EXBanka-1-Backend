...
func TestAccountClient_ReserveFunds_MapsFieldsAndReturnsResponse(t *testing.T) {
	...
	resp, err := c.ReserveFunds(context.Background(), 7, 123, decimal.NewFromFloat(100.0), "RSD", "idem-key-rf", "stock_order")
	if err != nil {
...
func TestAccountClient_ReserveFunds_PropagatesErrors(t *testing.T) {
	...
	_, err := c.ReserveFunds(context.Background(), 1, 2, decimal.NewFromInt(10), "RSD", "idem-key-rf-err", "stock_order")
...
func TestAccountClient_ReleaseReservation_PassesOrderID(t *testing.T) {
	...
	if _, err := c.ReleaseReservation(context.Background(), 555, "idem-key-rr", "stock_order"); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestAccountClient_PartialSettleReservation_MapsFields(t *testing.T) {
	...
	if _, err := c.PartialSettleReservation(context.Background(), 10, 20, decimal.NewFromFloat(12.5), "fill", "idem-key-ps", "stock_order"); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestAccountClient_GetReservation_PassesOrderID(t *testing.T) {
	...
	resp, err := c.GetReservation(context.Background(), 999, "stock_order")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
