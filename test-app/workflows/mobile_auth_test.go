...
func TestMobileAuth_RequestActivation_ValidEmail(t *testing.T) {
	...
	c := newClient()
	resp, err := c.POST("/api/mobile/auth/request-activation", map[string]interface{}{
		"email": email,
	})
	if err != nil {
...
func TestMobileAuth_Activate_MissingFields(t *testing.T) {
	t.Parallel()
	c := newClient()
	resp, err := c.POST("/api/mobile/auth/activate", map[string]interface{}{
...
func TestMobileAuth_Refresh_MissingDeviceID(t *testing.T) {
	t.Parallel()
	c := newClient()
	resp, err := c.POST("/api/mobile/auth/refresh", map[string]interface{}{
...
func TestMobileAuth_DeviceEndpoints_RequireAuth(t *testing.T) {
	...
	resp, err := c.GET("/api/mobile/device")
	if err != nil {
	...
	resp, err = c.POST("/api/mobile/device/deactivate", nil)
	if err != nil {
	...
	resp, err = c.POST("/api/mobile/device/transfer", map[string]interface{}{
		"email": "test@example.com",
	})
	if err != nil {
