...
func TestOrder_CreateMarketBuyOrder(t *testing.T) {
	...
	resp, err := agentC.POST("/api/v3/me/orders", map[string]interface{}{
...
func TestOrder_CreateOrder_Unauthenticated(t *testing.T) {
	t.Parallel()
	c := newClient()
	resp, err := c.POST("/api/v3/me/orders", map[string]interface{}{
		"listing_id": 1,
		"direction":  "buy",
		"order_type": "market",
		"quantity":   1,
...
func TestOrder_ListMyOrders(t *testing.T) {
	...
	resp, err := agentC.GET("/api/v3/me/orders")
	if err != nil {
		t.Fatalf("error: %v", err)
	}
...
func TestOrder_GetMyOrder(t *testing.T) {
	...
	resp, err := agentC.GET("/api/v3/me/orders/" + helpers.FormatID(orderID))
	if err != nil {
		t.Fatalf("error: %v", err)
	}
	helpers.RequireStatus(t, resp, 200)
...
func TestOrder_GetMyOrder_NotFound(t *testing.T) {
	...
	resp, err := agentC.GET("/api/v3/me/orders/999999")
	if err != nil {
		t.Fatalf("error: %v", err)
	}
...
func TestOrder_CancelOrder(t *testing.T) {
	...
	resp, err := agentC.POST("/api/v3/me/orders/"+helpers.FormatID(orderID)+"/cancel", nil)
	if err != nil {
		t.Fatalf("error: %v", err)
	}
...
func TestOrder_CancelOrder_NotFound(t *testing.T) {
	...
	resp, err := agentC.POST("/api/v3/me/orders/999999/cancel", nil)
	if err != nil {
		t.Fatalf("error: %v", err)
	}
	helpers.RequireStatus(t, resp, 404)
...
func TestOrder_ListOrders_RequiresSupervisor(t *testing.T) {
	...
	resp, err := agentC.GET("/api/v3/orders")
	if err != nil {
		t.Fatalf("error: %v", err)
	}
...
func TestOrder_ListOrders_Supervisor(t *testing.T) {
	...
	resp, err := supervisorC.GET("/api/v3/orders")
	if err != nil {
		t.Fatalf("error: %v", err)
	}
	helpers.RequireStatus(t, resp, 200)
...
func TestOrder_ApproveOrder_RequiresSupervisor(t *testing.T) {
	...
	resp, err := agentC.POST("/api/v3/orders/1/approve", nil)
	if err != nil {
		t.Fatalf("error: %v", err)
	}
	helpers.RequireStatus(t, resp, 403)
