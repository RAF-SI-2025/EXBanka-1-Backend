...
func TestWorkflow_FullBankingOnboarding(t *testing.T) {
	...
	createClientResp, err := adminClient.POST("/api/v3/clients", map[string]interface{}{
	...
	createAcctResp, err := adminClient.POST("/api/v3/accounts", map[string]interface{}{
		"owner_id":        clientID,
...
func TestWorkflow_FullPaymentWithFee(t *testing.T) {
	...
	createBResp, err := adminClient.POST("/api/v3/clients", map[string]interface{}{
	...
	acctBResp, err := adminClient.POST("/api/v3/accounts", map[string]interface{}{
		"owner_id":        clientBID,
		"account_kind":    "current",
		"account_type":    "personal",
		"currency_code":   "RSD",
...
func TestWorkflow_FullCrossCurrencyTransfer(t *testing.T) {
	...
	createResp, err := adminClient.POST("/api/v3/clients", map[string]interface{}{
	...
	rateResp, err := newClient().GET("/api/v3/exchange/rates/EUR/RSD")
	if err != nil {
...
func TestWorkflow_FullLoanLifecycle(t *testing.T) {
	...
	clientReqResp, err := clientC.GET("/api/v3/me/loan-requests")
	if err != nil {
