...
func TestOwnership_BobCannotReadAliceLoan(t *testing.T) {
	...
	resp, err := bobC.GET("/api/me/loans/" + strconv.Itoa(aliceLoanID))
	if err != nil {
...
func TestOwnership_BobCannotReadAlicePayment(t *testing.T) {
	...
	payResp, err := aliceC.POST("/api/me/payments", map[string]interface{}{
	...
	resp, err := bobC.GET("/api/me/payments/" + strconv.Itoa(alicePayID))
	if err != nil {
		t.Fatalf("bob GET: %v", err)
	}
	if resp.StatusCode != 404 {
...
func TestOwnership_BobCannotSetPinOnAliceCard(t *testing.T) {
	...
	resp, err := bobC.POST("/api/me/cards/"+strconv.Itoa(aliceCardID)+"/pin", map[string]interface{}{
		"pin": "1234",
	})
	if err != nil {
...
func TestOwnership_BobCannotBlockAliceCard(t *testing.T) {
	...
	resp, err := bobC.POST("/api/me/cards/"+strconv.Itoa(aliceCardID)+"/temporary-block", map[string]interface{}{
		"duration_hours": 1,
...
func TestOwnership_BodyClientIdIgnoredOnLoanRequest(t *testing.T) {
	...
	resp, err := bobC.POST("/api/me/loan-requests", map[string]interface{}{
