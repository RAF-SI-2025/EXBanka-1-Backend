...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/roles/{role_name}/permissions": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Role name (e.g. EmployeeBasic)",
                        "name": "role_name",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v1/roles/{role_name}/permissions/{permission}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v2/accounts/by-number/{account_number}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v2/cards/authorized-person": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v2/loans/requests/{id}/approve": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v2/loans/requests/{id}/reject": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.revokeSessionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v3/me/otc/offers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "initiator|counterparty|either",
                        "name": "role",
                        "in": "query"
                    }
                ],
