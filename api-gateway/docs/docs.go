...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/mobile/verifications/{id}/submit": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/mobile/verifications/{id}/biometric": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
